...
public enum SimulatorOption {
	...
	UNIFIED_TIME_SERIES_OUTPUT("unified_time_series_output", false,	"command line option under JSIM so that both for event based and time based simulations we have the same columns in the data section: time, event, obs1, obs2, obs3, ... , obsn."),
	...
	static {
		...
		for (SimulatorOption option : values()) {
	...
	private SimulatorOption(String shortName, String longName, boolean hasArguments, String description) {
	...
	private SimulatorOption(String longName, boolean hasArguments, String description) {
		this.shortName = null;
		this.longName = longName;
		this.description = description;
		this.hasArguments = hasArguments;
