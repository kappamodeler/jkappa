...
public class InhibitionMapComputationOperation extends AbstractOperation<InfluenceMap> {
	private final SimulationData simulationData;
	
	public InhibitionMapComputationOperation(SimulationData simulationData) {
		super(simulationData, OperationType.INHIBITION_MAP);
		this.simulationData = simulationData;
	}
	
	//TODO separate inhibition map from influence map creation
