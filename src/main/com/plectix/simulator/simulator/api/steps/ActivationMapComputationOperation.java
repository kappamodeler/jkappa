...
public class ActivationMapComputationOperation extends AbstractOperation<InfluenceMap> {
	private final SimulationData simulationData;
	
	public ActivationMapComputationOperation(SimulationData simulationData) {
		super(simulationData, OperationType.ACTIVATION_MAP);
		this.simulationData = simulationData;
	}
	
	//TODO separate activation map from influence map creation
