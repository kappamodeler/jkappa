...
/*package*/ class DensityDependantLiveDataConsumer extends AbstractLiveDataConsumer {
	...
	private Collection<LiveDataPoint> removeNumberOfPoints(Collection<LiveDataPoint> data, int quantity) {
