...
public class TempExperimentRunner implements ExperimentListener {
	
	private static final PlxLogger LOGGER = ThreadLocalData.getLogger(TempExperimentRunner.class);
	...
	public TempExperimentRunner(SimulatorInputData simulatorInputData) {
		super();
	...
	public static void main(String[] args) throws Exception {
		...
		TempExperimentRunner experimentRunner = new TempExperimentRunner(new SimulatorInputData(commandLine.getSimulationArguments()));
