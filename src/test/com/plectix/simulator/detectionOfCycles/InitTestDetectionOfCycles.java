...
public class InitTestDetectionOfCycles {
	...
	public static void init(String dir, String count) {
	...
	public static CContactMap getContactMap() {
		return mySimulator.getSimulationData().getKappaSystem().getContactMap();
	}
