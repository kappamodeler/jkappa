...
public class CorrectionsDataParser extends Parser<Map<String, SortedSet<Long>>>{
	...
	private void addOrRemoveAll(Set<Long> set1, Set<Long> set2, ParseOptions options) {
	...
	private void processData(Set<Long> set, String command, 
			String currentName, ParseOptions options) {
