...
/*package*/ class GreatFileUtility {
		...
		if (!("".equals(line))) {
			...
			for (String str : pieces) {
				...
				try {
					...
					for (long i = number.getLower(); i <= number
							.getUpper(); i += number.getStep()) {
						
						add(set, i);
						
					}
				} catch (NumberFormatException e) {
					System.out.println("number format exception on " + str);
				}
			}
		}
	...
	public static Set<Long> allXInternal() {
		Set<Long> set = new TreeSet<Long>();
		addAll(set, Arrays.asList(new Integer[] {
						2, 4, 5, 8, 10, 14, 18, 22, 26, 
						30, 34, 38, 42, 46, 50, 54, 58, 62, 64, 
						66, 68, 70, 74, 76, 77, 80, 84, 87, 88, 
						89, 91, 92, 93, 96, 100, 103, 104, 105, 
						107, 108, 109, 112, 116, 119, 120, 121, 
						123, 124, 125, 128, 130, 132, 133, 134, 
						135, 136, 137}));
	...
	public static Set<Long> allKInternal() {
		return Collections.unmodifiableSet(fillByLine("11 21=27 37=43 53=59 67=71"));
	}
	...
	public static Set<Long> allY() {
		return Collections.unmodifiableSet(fillByLine("3 4 5 12=58 78=92 94-125"));
	}
}
