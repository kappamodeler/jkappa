...
public class Reachables {
	...
	public boolean equals(Object aReachables){
		...
		if(this == aReachables) return true;
		
		if(aReachables == null) return false;
		
		if(getClass() != aReachables.getClass()) return false;
		
		Reachables reachables = (Reachables) aReachables;
		
		final boolean isEqualName = reachables.name.equals(this.name);
		final boolean isEqualCardinal = reachables.cordinal.equals(this.cordinal);
