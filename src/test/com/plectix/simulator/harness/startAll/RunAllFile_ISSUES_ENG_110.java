...
public class RunAllFile_ISSUES_ENG_110 {

	private static final String separator = File.separator;
	private static final String allPath = "test.data" + separator + "file_110" + separator;
	
	private static final String pathForSourseFile =  allPath + "all" + separator;
	private static final String pathForResults = allPath + "results" + separator;
	...
	private String getFileName(String path) {
		...
		fileName = fileName.substring(0, (int) (fileName.length() - suffixFiles.length()));
		return fileName;
	}
	
	
	public RunAllFile_ISSUES_ENG_110(String path) {
